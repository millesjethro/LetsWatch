...
class NetflixAdapter(private var movielist: ArrayList<Title>, private var context: Context): RecyclerView.Adapter<NetflixAdapter.MovieViewHolder>() {
    inner class MovieViewHolder(private val binding: ContentListViewBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(moviedata: Title) {
            ...
            val aniSlideup = AnimationUtils.loadAnimation(context, com.auf.letswatch.R.anim.slide_up)
